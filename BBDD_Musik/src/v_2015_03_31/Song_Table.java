...
//		}
		...
		if( tbTypMusic.getText().equals("") && tbAuthor.getText().equals("") &&
		...
		{
			this.setTitle("All Songs: " + tbTypMusic.getText() + " " + tbAuthor.getText()
					+" " + tbCD_Name.getText() + " "+ tbSong_Name.getText() + "" 
				       + tbCountry.getText() );
			
			jlabel0.setText(tbTypMusic.getText() + " " + tbAuthor.getText()+" "
					       + tbCD_Name.getText() + " "+ tbSong_Name.getText() + "  " 
					       + tbCountry.getText());	
		}
