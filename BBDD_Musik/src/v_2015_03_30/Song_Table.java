		...
		ListSelectionListener, KeyListener, MouseListener
{
	...
	private String total_filterConditions;
	...
	private void initializeComponents()
	{
		...
		this.setTitle("List of Songs " + cdName);
		...
		jlabel0.setBounds(350, 1, 250, 25);
	...
	public void resetLabelName()
	{
		...
		{
			this.setTitle("List of Songs CD  " + tbCD_Name.getText() +" " +  tbAuthor.getText());
