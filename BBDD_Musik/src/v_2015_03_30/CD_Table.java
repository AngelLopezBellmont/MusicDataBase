		...
		ListSelectionListener, KeyListener, MouseListener
{
	...
	private void initializeComponents()
	{
		...
		this.setTitle("Musik all CD");
		this.setSize(998, 585);
		...
		//jspTabelle.setBounds(0, 100, 950, 400);
...
//	}
	...
	{
		String cdAuthor = (Tabelle.getValueAt(Tabelle.getSelectedRow(), 2).toString());
		String cdSong = (Tabelle.getValueAt(Tabelle.getSelectedRow(), 3).toString());
