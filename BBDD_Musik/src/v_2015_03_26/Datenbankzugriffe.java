...
public class Datenbankzugriffe extends JFrame implements ActionListener, WindowListener
{
	...
	private void showCD_SongsTable()
	{
		CD_Songs_Table cds = new CD_Songs_Table();
		cds.showDialog(this);
	}
...
//			}
			...
			{
				JOptionPane.showMessageDialog(Datenbankzugriffe.this, "Fehler beim Einlesen der Datei " + Dateiname + ": " + ex.getMessage(), "E/A Fehler", JOptionPane.ERROR_MESSAGE);
			}
			...
			JOptionPane.showMessageDialog(Datenbankzugriffe.this, String.format("Es wurden %s Datensätze eingelesen.\nEs wurden %s Datensätze erfolgreich importiert.", 
